    ...
    <div class="container" >
        ...
        <div style="font-family:sans-serif;padding:10px;text-align:center;">
            ...
            <div style="text-align: center;">
                <a href="<?php echo $BASE_URL; ?>"><button style="background-color:#2965ff; padding:5%; border-radius: 10px; border: 5px solid #03fcd3; font-size: 25px; cursor:pointer; font-weight:bold;padding:1%;color:white;">Continue</button></a>
            </div>            
        </div>
    </div>
</body>
